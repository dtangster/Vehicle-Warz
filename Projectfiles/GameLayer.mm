...
-(id) init
{
	if ((self = [super init]))
	{
        ...
        player1Vehicle = [[Vehicle alloc] initWithName: @"Triceratops" usingImage:@"triceratops.gif"];
        ...
        player2Vehicle = [[Vehicle alloc] initWithName: @"Mammoth" usingImage:@"mammoth.gif"];
